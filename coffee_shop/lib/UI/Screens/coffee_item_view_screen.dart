...
import 'package:coffee_shop/UI/Components/ItemViewComponents/sugar.dart';
...
class CoffeeItemViewScreen extends StatelessWidget {
  ...
  CoffeeItemViewScreen({this.sugarCount = 2, this.temperature});
  ...
  Widget build(BuildContext context) {
    ...
    height =
        mData.size.height - _appBar.preferredSize.height - mData.padding.top;
  ...
  void initializeData(BuildContext context) {
    ...
    if (_item != null) {
      ...
      sugarCount = coffeeItem.sugar;
      sugarType = coffeeItem.sugarType;
    }
    ...
    sideFontSize =
        (height * 0.04 > maxFontSize * 0.9 ? maxFontSize * 0.9 : height * 0.04);
  }
    ...
    return Container(
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            Sugar(height, sideFontSize, _item, _setSugar, sugarCount,
                _setSugarType),
            SizedBox(
              height: height * 0.03,
            ),
      ...
      child: ButtonTheme(
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            ...
            if (quest != null) {
              QuestDB.setQuestStatus(StaticData.currentUser.userID,
                  QuestStatus.ITEM_ADDED_TO_CART, quest.calendarWeek);
            }
  ...
  void _setSugarType(int sugarType) {
