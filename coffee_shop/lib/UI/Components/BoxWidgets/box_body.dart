...
class _BoxBodyState extends State<BoxBody> {
    ...
    return Center(
      child: Column(
        ...
        children: <Widget>[
          StrokedText(
              text:
                  LanguageModel.youHaveNoBoxYet[LanguageModel.currentLanguage]),
  ...
  Widget _getOpenerWidget(AsyncSnapshot snap, DocumentSnapshot ds,
  ...
  Widget _noOrderPage(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: <Widget>[
          StrokedText(
            text: LanguageModel.noCurrentOrders[LanguageModel.currentLanguage],
          ),
  ...
  Widget _getApproppriateImage(bool open, BuildContext context, String boxID,
      String orderID, double opacity) {
        ...
        child: GestureDetector(
            onTap: () async {
              if (boxID != "-1") {
                ...
                if (answer == OpenBoxStatus.ERROR_HAPPENED) {
