...
class CartOnHomeScreen extends StatefulWidget {
  final List<ShopItem> _items;

  CartOnHomeScreen(this._items);

  @override
  _CartOnHomeScreenState createState() => _CartOnHomeScreenState();
}

class _CartOnHomeScreenState extends State<CartOnHomeScreen> {
  double _maxHeight;
  double _height;
  double _width;
  double _heightBreak;
