...
class _WalletBodyState extends State<WalletBody> {
    ...
    {
        height = MediaQuery.of(context).size.height - new AppBar().preferredSize.height - MediaQuery.of(context).padding.top;
                ...
                [
                    ...
                    (
                        ...
                        [
                            ...
                            Container
                            (
                                child: StrokedText(text: LanguageModel.purchaseHistory[LanguageModel.currentLanguage], size: height*0.09*0.35),
                                margin: EdgeInsets.only(bottom: height*0.001, top: height * 0.001),
                            ),
        ...
        (
            ...
            (
                ...
                (
                    ...
                    (
                        borderRadius: BorderRadius.all(Radius.circular(height*0.44*0.15))
                    ),
                    child: Stack
                    (
                        children: <Widget>
    ...
    Widget _buildPlaceHeader(BuildContext context, Shop currentShop)
    {
        ...
        (
            ...
            (
                ...
                (
                    borderRadius: BorderRadius.only(topLeft: Radius.circular(height*0.44*0.15), topRight: Radius.circular(height*0.44*0.15)),
                ...
                (
                    ...
                    (
                        ...
                        [
                            ...
                            Icon(Icons.navigation,color: Colors.blue, size: height*0.05,),
                        ],
                    ),
                )
            ),
