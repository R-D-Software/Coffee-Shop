...
class FavouriteListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        _navigateToItemView(context, this.item.documentID);
      },
      child: Stack(
        children: <Widget>[
          _getInfoRow(context),
    ...
    return Card(
        ...
        child: Container(
          ...
          decoration: new BoxDecoration(
            ...
            image: DecorationImage(image: NetworkImage(this.item.imageUrl), fit: BoxFit.fill),
          ),
        ));
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              deleteItemFromFavouriteList(item.documentID);
            },
      ...
      decoration: BoxDecoration(
          border: Border.all(color: Colors.white, width: 2), color: Color.fromRGBO(189, 150, 150, 1), borderRadius: BorderRadius.only(bottomRight: Radius.circular(10), topRight: Radius.circular(10))),
    );
  }
